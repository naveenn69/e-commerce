        ...
        <ul>
            ...
            <li><a href=""><i class="fa fa-user" aria-hidden="true"></i>SHOP OWNER</a>
                ...
                <div class="submenu">
                 ...
                 <li class="active"><a href="admin_viewuser.py"><i class="fa fa-user" aria-hidden="true"></i>User</a></li>
...
q = "select * from user where STATUS = 'LOGGED'"
cur.execute(q)
res = cur.fetchall()
for i in res:
    print(""" 
       <tbody>
        <tr class="active-row">
            ...
            <td><input type="text" value="%s" name="name" style="border: none; width:80px;text-transform: uppercase;"></td>
            <td><input type="text" value="%s" name="mail" style="border: none; width:250px;"></td>
            <td><b>%s</b></td>
            <td><b>%s</b></td>
            <td><b>%s</b></td>""" % (i[0], i[1], i[2], i[3],i[5],i[7]))
    print("""
...
q = "select * from user where STATUS='DELETED'"
cur.execute(q)
res = cur.fetchall()
for i in res:
    print(""" 
       <tbody>
        <tr class="active-row">
            ...
            <td><input type="text" value="%s" name="mail" style="border: none; width:250px;"></td>
            <td><b>%s</b></td>
            <td><b>%s</b></td>""" % (i[0], i[1], i[2],i[3],i[5]))
    print("""
            </form>
        </tr>
        </tbody>
...
if delete != None:
    ...
    q2 = """update user set STATUS='Deleted' where ID='%s'""" % (ID)
