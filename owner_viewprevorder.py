...
for r in pr:
    ...
    <nav>
            ...
            <ul>
                ...
                <li><a href="owner_vieworders.py?info=%s"><i class="fa fa-user" aria-hidden="true"></i>ORDERS</a></li>
                <li class="active"><a href=""><i class="fa fa-user" aria-hidden="true"></i>PREVIOUS ORDERS</a></li>
...
mail = r[3]
q = """select * from user_orders where OWNER_ID='%s' and STATUS='%s'""" % (mail, 'ordered')
cur.execute(q)
res = cur.fetchall()
for i in res:
    print(""" 
